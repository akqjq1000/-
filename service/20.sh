...
echo "************************************************************************************" >> $RESULT
echo " [U-09] /etc/hosts 파일 소유자 및 권한 설정" >> $RESULT
echo " [양호] /etc/hosts 파일의 소유자가 root이고, 권한이 600 이하인 경우" >> $RESULT
echo " [취약] /etc/hosts 파일의 소유자가 root가 아니거나, 권한이 600 이하가 아닌 경우" >> $RESULT
echo "************************************************************************************" >> $RESULT

retval=""

passwd_file="/etc/hosts"
